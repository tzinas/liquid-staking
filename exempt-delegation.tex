...
% TODO (w/dionyziz): Maybe before closing her position?
...
%TODO (tzinas): The flash loan will be explained in the next paragraph.
...
%TODO(tzinas): check if this is true
...
Aave~\cite{aave} and concern loans in Ethereum.}
% TODO (tzinas): mention date
...
\begin{gather*}
  ...
  % TODO (w/ dionyziz): is naming necessary here?
  % TODO (w/ dionyziz): should the previous equation be named asterisk?
\end{gather*}
