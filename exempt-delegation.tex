...
with \asset flash loan cost factor $\betaasset = 0.0009$,
collateral ratio $\gammastasset = 1.2$ and \stasset loan cost factor $f = 1.000006$.
...
market dominations $\frac{u}{b_0}$, and assuming free money borrowing,
