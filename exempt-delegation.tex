...
\begin{gather*}
  \frac{q}{\phi} = \frac{1}{b_0 \gamma}(f p u + f u - b_0 \betaasset \gamma - 2 u \sqrt{fp (f-1)} - u)
\end{gather*}
...
\begin{figure}[htb]
  ...
  \begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\textwidth]{./plots/plotf20.pdf}
    \caption{Collateral $u = 20\%$ of $b_0$.}
    \label{fig:plotf20}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.49\textwidth}
