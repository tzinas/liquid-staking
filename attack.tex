...
i.e., the cost $f$ of money borrowing (which is always $> 1$) is
...
% TODO (w/ dionyziz): consider the case p < 1

\subsection{The Market price of \stasset}\label{sec:stasset-price}
% TODO (w/ dionyziz): Consider moving this to appendix
...
% TODO (w/ dionyziz): explore whether the principle of remittances is actually implemented anywhere

% TODO (w/dionyziz): mention in a remark (maybe later) that exchange rates between asset/stAsset may not
...
% TODO (w/dionyziz): Re-state the attack formulae using the corrected pricing of stasset