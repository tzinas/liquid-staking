...
If no overcollateralization is required and the adversary uses her
whole initial capital $u$ \asset as
collateral, she obtains a loan of $z = u \frac{s_0}{b_0}$ \stasset and
then sells them back for $b^* = u$ \asset.
The adversary's profit relative to her initial capital is
