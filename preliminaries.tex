...
In order to take a non-flash loan, collateral in a different currency must be deposited for the duration
...
functionalities of any liquid staking protocol in
\ifproceedings
  the full version of this paper~\cite{liquid-staking-eprint}.
\else
  Appendix~\ref{app:contract}.
\fi
