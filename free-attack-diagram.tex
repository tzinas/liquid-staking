...
\draw[color=myred] ($(R0) + (0,3pt)$) -- ($(R0) + (0,-3pt)$);
\draw[color=myred] ($(R5) + (0,3pt)$) -- ($(R5) + (0,-3pt)$);
\draw[color=myred] (R0) -- (R5) node[color=black,midway, above=3pt](L) {$b$ {\tiny \asset}};
\node[text=myred,above=3pt] at (L) {flash loan};
